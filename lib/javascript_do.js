  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "InitialiserOperator": parse_InitialiserOperator,
        ...
        "DoSyntaxStatement": parse_DoSyntaxStatement,
        "DoStatement": parse_DoStatement,
        "DoBlock": parse_DoBlock,
        "DoStatementList": parse_DoStatementList,
        "DoExpressionStatement": parse_DoExpressionStatement,
        "DoExpression": parse_DoExpression,
        "DoAssignmentExpression": parse_DoAssignmentExpression,
        "DoIfExpression": parse_DoIfExpression,
        "ReturnExpression": parse_ReturnExpression,
        "ThrowExpressionStatement": parse_ThrowExpressionStatement,
      ...
      function parse_VoidToken() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "void"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_PrimaryExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return { type: "This" }; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ObjectLiteral() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, properties) {
              return {
                type:       "ObjectLiteral",
      ...
      function parse_PropertyAssignment() {
        ...
        if (result0 === null) {
          pos0 = pos;
          pos1 = pos;
          result0 = parse_GetToken();
          if (result0 !== null) {
            result1 = parse___();
            if (result1 !== null) {
              result2 = parse_PropertyName();
              if (result2 !== null) {
                result3 = parse___();
                if (result3 !== null) {
                  if (input.charCodeAt(pos) === 40) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, name, param, body) {
                  return {
      ...
      function parse_MemberExpression() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            result0 = parse_DoSyntaxStatement();
            if (result0 === null) {
              pos2 = pos;
              pos3 = pos;
      ...
      function parse_NewExpression() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, constructor) {
                return {
                  type:        "NewOperator",
                  constructor: constructor,
                  arguments:   []
      ...
      function parse_CallExpression() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            result2 = (function(offset, arguments) {
                    return {
      ...
      function parse_VariableStatement() {
        ...
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_VariableDeclarationList();
            if (result2 !== null) {
              result3 = parse_EOS();
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
      ...
      function parse_VariableDeclaration() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, initialiser) {
              return {
                type:     "VariableDeclaration",
                name:     name,
                operator: initialiser.operator !== "" ? initialiser.operator : null,
                value:    initialiser.value !== "" ? initialiser.value : null
              };
            })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
      ...
      function parse_Initialiser() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_InitialiserOperator();
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
      ...
      function parse_InitialiserNoIn() {
        ...
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_AssignmentExpressionNoIn();
            if (result2 !== null) {
              result0 = [result0, result1, result2];
            } else {
              result0 = null;
      ...
      function parse_InitialiserOperator() {
        var cacheKey = "InitialiserOperator@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_EmptyStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return { type: "EmptyStatement" }; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ContinueStatement() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, identifier) { return identifier; })(pos2, result2[0]);
            }
            if (result2 === null) {
              pos = pos2;
            }
      ...
      function parse_SwitchStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expression, clauses) {
              return {
      ...
      function parse_CaseBlock() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, before, defaultAndAfter) {
      ...
      function parse_CaseClause() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, selector, statements) {
              return {
                type:       "CaseClause",
                selector:   selector,
      ...
      function parse_LabelledStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, label, statement) {
              return {
      ...
      function parse_ThrowStatement() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_Expression();
            if (result2 !== null) {
              result3 = parse_EOSNoLineTerminator();
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
              } else {
                result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, exception) {
              return {
                type:      "ThrowStatement",
                exception: exception
              };
      ...
      function parse_TryStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, block, catch_, finally_) {
              return {
                type:      "TryStatement",
                block:     block,
                "catch":   catch_,
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, block, catch_) {
                return {
                  type:      "TryStatement",
                  block:     block,
                  "catch":   catch_,
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, block, finally_) {
                  return {
                    type:      "TryStatement",
                    block:     block,
                    "catch":   null,
      ...
      function parse_Catch() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, identifier, block) {
              return {
                type:       "Catch",
      ...
      function parse_DebuggerStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return { type: "DebuggerStatement" }; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_DoSyntaxStatement() {
        var cacheKey = "DoSyntaxStatement@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset, monad, statement) {
              return {
                type: "DoSyntaxStatement",
                monad:     monad,
                statement: statement
              };
            })(pos0, result0[2], result0[4]);
      ...
      function parse_DoStatement() {
        ...
        if (result0 === null) {
          result0 = parse_DoExpressionStatement();
          if (result0 === null) {
            result0 = parse_ThrowExpressionStatement();
            if (result0 === null) {
              result0 = parse_FunctionExpression();
            }
          }
      ...
      function parse_DoStatementList() {
        var cacheKey = "DoStatementList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_DoExpressionStatement() {
        var cacheKey = "DoExpressionStatement@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_DoExpression() {
        var cacheKey = "DoExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_DoAssignmentExpression();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_DoAssignmentExpression();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_DoAssignmentExpression() {
        var cacheKey = "DoAssignmentExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse___();
              if (result3 !== null) {
                result4 = parse_DoAssignmentExpression();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
        ...
        if (result0 === null) {
          result0 = parse_ConditionalExpression();
          if (result0 === null) {
            result0 = parse_DoIfExpression();
            if (result0 === null) {
              result0 = parse_ReturnExpression();
              if (result0 === null) {
                result0 = parse_DoSyntaxStatement();
              }
            }
      ...
      function parse_DoIfExpression() {
        var cacheKey = "DoIfExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_ReturnExpression() {
        var cacheKey = "ReturnExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_ThrowExpressionStatement() {
        var cacheKey = "ThrowExpressionStatement@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
